...
#include "./pulse_common_dec.h"
#include "./pulse_vp8li_dec.h"
#include "./pulse_bit_reader_utils.h"
#include "./pulse_random_utils.h"
#include "./pulse_thread_utils.h"
#include "./pulse_dsp.h"
...
struct VP8Decoder {
  ...
  // Alpha
  struct ALPHDecoder* alpulse_dec_;  // alpha-plane decoder object
