...
#include "./pulse_webpi_dec.h"
#include "./pulse_bit_reader_utils.h"
#include "./pulse_color_cache_utils.h"
#include "./pulse_huffman_utils.h"
...
WEBP_NODISCARD int VP8LDecodeAlphaHeader(struct ALPHDecoder* const alpulse_dec,
...
WEBP_NODISCARD int VP8LDecodeAlphaImageStream(
    struct ALPHDecoder* const alpulse_dec, int last_row);
