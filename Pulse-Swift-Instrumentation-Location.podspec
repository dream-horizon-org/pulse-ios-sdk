Pod::Spec.new do |spec|
  spec.name = "Pulse-Swift-Instrumentation-Location"
  spec.version = "0.0.1"
  spec.summary = "Swift OpenTelemetry Location Instrumentation"
  ...
  spec.pod_target_xcconfig = { "OTHER_SWIFT_FLAGS" => "-module-name Location -package-name pulse_swift_instrumentation_location" }
end
